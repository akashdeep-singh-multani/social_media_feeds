...
export const selectPostLikeById = (postId: string) =>
  createSelector(selectPostLikes, (likes) =>
    likes.find((like) => like.postId === postId)
  );

export const selectLikeIdByPostId = (postId: string) =>
  createSelector(selectPostLikes, (postLikes) => {
